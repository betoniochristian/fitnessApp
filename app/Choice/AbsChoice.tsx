...
export default function AbsChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Abs')}>
        <Image source={absIcon} style={styles.image1} />
            <View style={styles.textmsg}>
              <Text style={styles.buttonText}>Mat Workout</Text>
              <Text style={styles.buttonText5}>Learn proper techniques exercises here.</Text>
            </View>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Mat/NoEquipment')}>
