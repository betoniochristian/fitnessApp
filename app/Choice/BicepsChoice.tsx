...
export default function BicepsChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Biceps')}>
        ...
        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/BicepsMachine')}>
