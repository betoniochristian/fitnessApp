...
export default function ChestChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Chest')}>
        ...
        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/ChestMachine')}>
