...
export default function LegsChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Legs')}>
        ...
        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/LegsMachine')}>
