...
export default function TricepsChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Triceps')}>
        ...
        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/TricepsMachine')}>
