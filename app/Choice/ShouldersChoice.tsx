...
export default function ShouldersChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Shoulders')}>
        <Image source={runningImage} style={styles.image1} />
            <View style={styles.textmsg}>
              <Text style={styles.buttonText}>Dumbbell</Text>
              <Text style={styles.buttonText5}>Learn proper techniques for dumbbell exercises here.</Text>
            </View>
        </TouchableOpacity>

        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/ShoulderMachine')}>
        <View style={styles.textmsg1}>
              <Text style={styles.buttonText}>With Machine</Text>
              <Text style={styles.buttonText5}>Machine-based exercises and track your strength progress.</Text>
            </View>
        <Image source={weightImage} style={styles.image2} />
        </TouchableOpacity>

        <TouchableOpacity style={styles.button1} onPress={() => router.push('/Mat/NoEquipment')}>
        <Image source={absIcon} style={styles.image1} />
            <View style={styles.textmsg}>
              <Text style={styles.buttonText}>No Equipment</Text>
              <Text style={styles.buttonText5}>Learn proper no-equipment exercise techniques here.</Text>
            </View>
        </TouchableOpacity>
