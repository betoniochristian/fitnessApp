...
export default function BackChoice() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        <TouchableOpacity style={styles.button1} onPress={() => router.push('/category/Back')}>
        ...
        <TouchableOpacity style={styles.button2} onPress={() => router.push('/Machine/BackMachine')}>
